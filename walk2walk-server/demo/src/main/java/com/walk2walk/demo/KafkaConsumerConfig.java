...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Position> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "positions");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Position> concurrentKafkaListenerContainerFactory() {
